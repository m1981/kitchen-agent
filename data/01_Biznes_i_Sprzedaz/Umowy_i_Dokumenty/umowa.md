...
2. Płatność zostanie zrealizowana w trzech transzach, w następujący sposób:      
    * a) **Transza I (ZADATEK):** w wysokości **________ zł** (słownie: ____________________), co stanowi _____% wartości umowy, płatny w dniu podpisania umowy. Zadatek przeznaczony jest na rezerwację terminu, zakup materiałów i uruchomienie produkcji w centrum CNC.
